--[[
    King Hub - Universal (fallback for unsupported games)
    Standard-character ESP + Aimbot (team check) + Movement/Misc. by MIRKO KING YT
]]
...
ScreenGui.Name = "MirkoHubUniversal"
...
credit.Position = UDim2.new(0, 210, 0, 0)
